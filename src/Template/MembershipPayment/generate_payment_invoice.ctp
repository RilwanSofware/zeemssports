	...
	<div class="col-md-12 box box-default">		
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				echo $this->Form->input("",["type"=>"hidden","name"=>"membership_valid_to","class"=>"check","value"=>(($edit)?$this->Gym->get_db_format(date($this->Gym->getSettings("date_format"),strtotime($data['end_date']))):'')])
				?>
		...
		<div class="col-md-offset-2 col-md-8">
        	<input type="submit" value="<?php echo __("Save");?>" name="<?php echo __("save_membership_payment");?>" class="btn btn-flat btn-success">
        </div>
		</form>
