	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">
			...
			foreach($data as $row)
			{
				...
				echo "<td>
						<a href='".$this->request->base ."/GymReservation/editReservation/{$row['id']}' class='btn btn-primary btn-flat' title='".__('Edit')."'><i class='fa fa-edit'></i> </a>
						<a href='".$this->request->base ."/GymReservation/deleteReservation/{$row['id']}' class='btn btn-danger btn-flat' title='".__('Delete')."' onclick=\"return confirm('$confirmMsg')\"><i class='fa fa-trash'></i></a>
				</td>";
				} 
				echo "</tr>";
			}
