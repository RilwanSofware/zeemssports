...
<section class="content">
	...
	<?php } ?>
		...
		<div class='form-group'>
			...
			<div class="col-md-8">
				<?php 
					$mesuarment = array("Height"=>__("Height"),"Weight"=>__("Weight"),"Chest"=>__("Chest"),"Waist"=>__("Waist"),"Thigh"=>__("Thigh"),"Arms"=>__("Arms"),"Fat"=>__("Fat"));
		...
		<div class='form-group'>
			...
			<div class="col-md-8">
				<?php echo $this->Form->input("",["autocomplete"=>"off","label"=>false,"class"=>"form-control date validate[required]","name"=>"result_date","value"=>($edit)?date($this->Gym->getSettings("date_format"),strtotime($data["result_date"])):""]); ?>
			</div>
		</div>
		<div class='form-group'>
			...
			<div class="col-md-4">
				<?php
				echo $this->Form->file("image",["class"=>"","style"=>"padding-top:13px"]);
