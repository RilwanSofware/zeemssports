...
{		
		...
		if(classes == null)
		{
			var message= "<?php echo __("Please Select Class or Add class class first."); ?>";
			alert(message);
			return false;
		}else {
			return true;
...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php	
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"weight","class"=>"form-control validate[custom[onlyNumberSp],maxSize[3]]","placeholder"=>$this->Gym->getSettings(__("weight")),"value"=>(($edit)?$data['weight']:''),"id"=>"weight"]);
			echo "</div>";	
			echo "</div>";
			...
			echo "<br><img src='{$this->request->webroot}webroot/upload/{$image}' class='img-responsive' id='blah' height='100px' width='150px'>";
			echo "</div>";	
			echo "</div>";			
			echo "</fieldset>";
			...
			echo "<br>";
			echo $this->Form->button(__("Save Member"),['class'=>"col-md-offset-2 btn btn-flat btn-success submit_button","name"=>"add_member"]);
			echo $this->Form->end();
		?>
