		...
		<div class="box-body">
			...
			foreach($data as $row)
			{
				...
				{	
					...
					echo "<a href='{$this->request->base}/GymStore/deleteRecord/{$row['id']}' class='btn btn-flat btn-danger' title='".__('Delete')."' onclick=\"return confirm('$confirmMsg')\"><i class='fa fa-trash'></i></a>";
					echo "</td>";
				}
