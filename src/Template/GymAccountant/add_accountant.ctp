...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">			
			<?php				
			echo $this->Form->create("addaccountant",["type"=>"file","class"=>"validateForm form-horizontal","role"=>"form","id"=>"form"]);
			...
			echo $this->Form->button(__("Save Accountant"),['class'=>"btn btn-flat btn-success submit_button","name"=>"add_group"]);
			echo "</div>";
			echo $this->Form->end();
			?>	
		</div>	
