	...
	<div class="col-md-12 box box-default">		
		...
		<div class="box-body">
			...
			foreach($data as $row)
			{
				...
				echo "<a href='{$this->request->base}/GymProduct/deleteProduct/{$row['id']}' class='btn1 btn btn-flat btn-danger' title='".__('Delete')."' onclick=\"return confirm('$confirmMsg')\"><i class='fa fa-trash'></i></a>"; 
				}				
				echo "</td>";
				}
				echo "</tr>";
