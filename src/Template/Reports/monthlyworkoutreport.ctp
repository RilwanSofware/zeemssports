	...
	<div class="col-md-12 box box-default">		
		...
		<form method="post" class="validateForm">  
			...
			<div class="form-group col-md-3">
				...
				<input id="curr_month" class="form-control validate[required]" type="text" value="<?php echo (isset($_POST['curr_month'])) ? $_POST["curr_month"]:"";?>" name="curr_month">
			</div>
		...
		<div class="box-body">
			...
			?>
				<tr>
					<td><?php echo $row[] = date($this->Gym->getSettings("date_format"),strtotime($drow['record_date']));?></td>
