	...
	<div class="col-md-12 box box-default">		
		...
		<form method="post" class="validateForm">  
			...
			<div class="form-group col-md-3">
				<label for="member_id"><?php echo __("Select Member");?></label>	<?php echo $this->Form->select("member_id",$members,["empty"=>__("Select Member"),"class"=>"form-control validate[required]"]);?>			
			</div>
			<?php
			}
			?>
